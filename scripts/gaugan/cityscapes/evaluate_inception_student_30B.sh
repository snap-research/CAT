...
python profile.py --dataroot database/cityscapes-origin \
  --distiller spade \
  --log_dir evaluation_logs/gaugan/cityscapes/inception/student/30B \
  --restore_teacher_G_path logs/gaugan/cityscapes/inception/teacher/checkpoints/best_net_G.pth \
  --pretrained_student_G_path logs/gaugan/cityscapes/inception/student/30B/checkpoints/best_net_G.pth \
...
python metric/kid_score.py \
  --real evaluation_logs/gaugan/cityscapes/inception/student/30B/eval/0/real/ \
  --fake evaluation_logs/gaugan/cityscapes/inception/student/30B/eval/0/Sfake/ \
  --gpu 0
