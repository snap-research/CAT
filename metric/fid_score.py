...
def _compute_statistics_of_path(path,
    ...
    if path.endswith('.npz'):
        ...
        m, s = calculate_activation_statistics(files,
                                               model,
                                               batch_size,
                                               dims,
                                               cuda,
...
def _compute_statistics_of_ims(ims,
                               model,
                               batch_size,
                               dims,
                               device,
                               use_tqdm=True):
    act = get_activations_from_ims(ims,
                                   model,
                                   batch_size,
                                   dims,
                                   device,
...
def calculate_fid_given_ims(ims_fake,
                            ims_real,
                            batch_size,
                            cuda,
                            dims,
    ...
    m1, s1 = _compute_statistics_of_ims(ims_fake,
                                        model,
                                        batch_size,
                                        dims,
                                        cuda,
                                        use_tqdm=use_tqdm)
    m2, s2 = _compute_statistics_of_ims(ims_real,
                                        model,
                                        batch_size,
                                        dims,
                                        cuda,
...
def calculate_fid_given_paths(paths,
    ...
    m1, s1 = _compute_statistics_of_path(paths[0],
                                         model,
                                         batch_size,
                                         dims,
                                         cuda,
                                         use_tqdm=use_tqdm)
    m2, s2 = _compute_statistics_of_path(paths[1],
                                         model,
                                         batch_size,
                                         dims,
                                         cuda,
