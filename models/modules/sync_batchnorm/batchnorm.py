...
class _SynchronizedBatchNorm(_BatchNorm):
    ...
    def forward(self, input):
        if not (self._is_parallel and self.training):
            return F.batch_norm(
                input, self.running_mean if self.track_running_stats else None, self.running_var if self.track_running_stats else None, self.weight, self.bias,
                self.training if self.track_running_stats else True, self.momentum, self.eps)
